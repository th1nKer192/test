...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand px-4 py-3 m-0" href="/main-menu">
                <img src="../assets/img/logo-ct-dark.png" class="navbar-brand-img" width="26" height="26"
                    alt="main_logo">
                <span class="ms-1 text-sm text-dark">Diễn Đàn Công Nghệ</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <h5 class="ms-5 mt-3">MENU</h5>
                <li class="nav-item">
                    <a class="nav-link text-dark" href="/main-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" href="">
                        ...
                        <span class="nav-link-text ms-1">Chức Năng Cá Nhân</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark" href="">
                        <i class="material-symbols-rounded opacity-5">view_in_ar</i>
                        <span class="nav-link-text ms-1">Chức Năng Admin</span>
                    </a>
                </li>
            </ul>
        </div>
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav d-flex align-items-center  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank" href="...">Đăng
                                Bài</a>
                        </li>
                        <li class="nav-item">
                            <a href="/dang-ky" class="btn btn-sm mb-0 me-1 bg-gradient-dark">Đăng Ký</a>
                        </li>
